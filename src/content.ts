...
export const contentByLocale: Record<LocaleKey, LandingContent> = {
  ru: {
    ...
    taglineSubtext: "Короткие рассказы и истории без фильтров. Чтобы сбить автопилот.",
    ...
    introduction: {
      ...
      paragraphs: [
        ...
        "Я психолог. Но если отбросить термины, я — человек, который помогает другим распутывать клубки мыслей, эмоций и чувств.",
        ...
        'Я верю, что есть два способа распутывать эти клубки. Один — в тишине личной сессии, через наш с тобой диалог. Другой — через истории, в которых ты вдруг узнаешь себя. Именно поэтому, помимо психологической практики, я веду проект "Отражения", где пишу те самые истории-зеркала.',
      ],
      highlight: {
        title: "Что я делаю?",
        paragraphs: [
      ...
      items: [
        {
          ...
          title: "Форматы",
          description:
            "* Длительность встреч — 1 час (60 минут).\n\n1. Онлайн.\nВидеозвонок (Zoom, Telegram, Viber, WhatsApp). Тебе достаточно найти тихое, уютное место, где тебя никто не потревожит, и стабильный интернет.\n\n2. В кабинете (Киев).\nЖивая встреча для тех, кому важно физическое присутствие.\nАдрес: ул. Никольско-Слободская, 6Г (рядом с метро Левобережная).",
        },
        {
          icon: "donate",
          title: "Стоимость",
          description:
            "1. Онлайн — cвободная оплата (donation).\nЯ понимаю реалии, в которых мы все сейчас живем, и не хочу, чтобы цена становилась преградой для тех, кому действительно нужна помощь. После встречи ты сам(а) определяешь сумму, которая кажется тебе посильной и честной.\n\n2. В кабинете — 2000 грн.\nЕсли для тебя принципиально важна личная встреча, мы можем провести её в кабинете. Для этого формата действует фиксированная стоимость.",
        },
        {
          icon: "lock",
      ...
      items: [
        {
          ...
          answer: "Не бывает мелких проблем. Если это причиняет боль, значит, это важно.",
        },
        {
          question: "А что, если я не смогу ничего сказать?",
          answer: "Это абсолютно нормально. Мы не будем сидеть в неловкой тишине. Разговор — это моя работа. Я помогу.",
        },
        {
          question: "Ты будешь меня анализировать?",
          answer: 'Моя цель не "разгадать" тебя, как ребус, а помочь тебе услышать и понять себя.',
        },
      ],
    },
    invitation: {
      heading: "Готов(а) сделать первый, самый маленький шаг?",
      body: "Просто напиши мне, чтобы договориться о нашей бесплатной 20-минутной встрече-знакомстве. Это тебя ни к чему не обязывает.",
      buttons: [
    ...
    story: {
      ...
      paragraphs: [
        ...
        'Я много путешествовал, жил в Йемене, Индии и Англии, имею два высших образования (экономическое и психологическое), успел поработать в разных сферах и на разных должностях — от "принеси-подай" до учредителя и руководителя собственной компании.',
        "Был женат, развелся, сохранил хорошие отношения и последние десять лет живу один. Ну, если быть точным, не совсем один — со мной кошка. Этот опыт не сделал меня гуру, но научил замечать в чужих историях ниточки, которые когда-то проходили через мою собственную. И понимать, что любой клубок можно распутать.",
      ],
    },
    footerNote: 'P.S. "Алекс Бон" — это мой псевдоним, так проще. А настоящее имя пусть остается для скучных бумаг.',
    blog: {
      badge: "Отражения",
      heroTitle: "Отражения",
  ...
  ua: {
    ...
    taglineSubtext: "Короткі розповіді та історії без фільтрів. Щоб збити автопілот.",
    ...
    introduction: {
      ...
      paragraphs: [
        ...
        "Я психолог. Але якщо відкинути терміни, я — людина, яка допомагає іншим розплутувати клубки думок, емоцій і почуттів.",
        "Моя робота — не ставити тобі діагнози і не розповідати, як слід жити. Моя робота — створити простір, у якому ти сам(а) зможеш почути себе. Можливо, вперше за довгий час.",
        'Я вірю, що є два способи розплутувати ці клубки. Один — у тиші особистої сесії, через наш із тобою діалог. Інший — через історії, у яких ти раптом упізнаєш себе. Саме тому, окрім психологічної практики, я веду проєкт "Відображення", де пишу ті самі історії-дзеркала.',
      ],
      highlight: {
        title: "Що я роблю?",
        paragraphs: [
      ...
      items: [
        {
          ...
          title: "Формати",
          description:
            "* Тривалість зустрічей — 1 година (60 хвилин).\n\n1. Онлайн.\nВідеодзвінок (Zoom, Telegram, Viber, WhatsApp). Тобі достатньо знайти тихе, затишне місце, де тебе ніхто не потурбує, та стабільний інтернет.\n\n2. У кабінеті (Київ).\nЖива зустріч для тих, кому важлива фізична присутність.\nАдреса: вул. Микільсько-Слобідська, 6Г (поруч з метро Лівобережна).",
        },
        {
          icon: "donate",
          title: "Вартість",
          description:
            "1. Онлайн — вільна оплата (donation).\nЯ розумію реалії, в яких ми всі зараз живемо, і не хочу, щоб вартість ставала перепоною для тих, кому справді потрібна допомога. Після зустрічі ти сам(а) визначаєш суму, яка здається тобі посильною і чесною.\n\n2. У кабінеті — 2000 грн.\nЯкщо для тебе принципово важлива особиста зустріч, ми можемо провести її в кабінеті. Для цього формату діє фіксована вартість.",
        },
        {
          icon: "lock",
      ...
      items: [
        {
          ...
          answer: "Не буває дрібних проблем. Якщо це тобі болить, значить, це важливо.",
        },
        {
          question: "А що, якщо я нічого не зможу сказати?",
          answer: "Це абсолютно нормально. Ми не сидітимемо в незручній тиші. Розмова — моя робота. Я підхоплю.",
        },
        {
          question: "Ти будеш мене аналізувати?",
          answer: 'Моя мета не "розгадати" тебе, мов ребус, а допомогти почути й зрозуміти себе.',
        },
      ],
    },
    invitation: {
      heading: "Готовий(а) зробити перший, зовсім невеликий крок?",
      body: "Просто напиши мені, щоб домовитися про нашу безкоштовну 20-хвилинну зустріч-знайомство. Це ні до чого тебе не зобов'язує.",
      buttons: [
    ...
    testimonials: {
      ...
      items: [
        'Хочу подякувати Олександрові за професіоналізм і чуйність. Він допоміг мені розібратися зі своїми внутрішніми переживаннями: я перестала жити лише майбутнім і навчилася цінувати момент "тут і зараз". Завдяки нашій роботі я позбулася надмірної самокритики, страхів і давнього почуття провини. З\'явилося більше впевненості у собі та спокою. Олександр створює безпечний простір, де можна чесно подивитися на свої труднощі й знайти рішення. Я дуже рада, що звернулася саме до нього.',
    ...
    story: {
      ...
      paragraphs: [
        ...
        'Я багато подорожував, жив у Ємені, Індії та Англії, маю дві вищі освіти (економічну та психологічну), встиг попрацювати у різних сферах і на різних посадах — від "принеси-подай" до засновника і керівника власної компанії.',
  ...
  en: {
    ...
    taglineSubtext: "Short stories and tales without filters. To break the autopilot.",
