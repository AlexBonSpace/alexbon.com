  ...
  ru: {
    ...
    introduction: {
      ...
      paragraphs: [
        ...
        'Я верю, что есть два способа распутывать эти клубки. Один — в тишине личной сессии, через наш с вами диалог. Другой — через истории, в которых ты вдруг узнаешь себя. Именно поэтому, помимо психологической практики, я веду проект "Отражения", где пишу те самые истории-зеркала.',
      ],
      highlight: {
        title: "Что я делаю?",
        paragraphs: [
      ...
      items: [
        {
          ...
          answer: "Не бывает мелких проблем. Если это болит у тебя, значит, это важно.",
        },
        {
      ...
      items: [
        {
          ...
          answer: "Не буває дрібних проблем. Якщо воно болить у тобі, значить, це важливо.",
        },
        {
